...
const diaryData: DiaryItem[] = [
  ...
  },
  {
    id: 13,
    content:
      "原文：作为一个艺术家，看到这个事件过程让我最惊讶和不理解的地方是，对岸都那么玻璃心吗？拿AI作品和艺术家的作品比较就冒犯到艺术家了？艺术家不应该是开放的心态去关注、研究或者掌握作为工具的AI么？AI也只是个工具而已，和艺术家手中的画笔一样的属性。为什么比较一下就被骂了，就被冒犯了？理解不了。/n 神了，国人AI观都这个B样子吗？真魏大勋我操，那个企业敢说自己的AI的资料没有未经同意训练人类创作的数据？拿着违规的抄袭你作品的者恬不知耻嘲讽你：“你看做的没有我好“，怎么就不冒犯了？还要人家“开放的心态”，抄袭的不是你，你当然开放心态了。还艺术家，我看像安装了codex就嘲讽RMS是老古板，安装antigravity觉得Eric S不懂大而美的“天才程序员” 我的观点就是所有AI产物不应该有版权。想做长文了，忙完考试可能。",
