...
2. **KernelSU** GPL-3.0开源，特点如名字，内核级root,优点就是不用做隐藏了，缺点就是就像wayland还没熬成婆，主要贡献者是中国人weishu,大佬也是太极的主要贡献者，[^2]在小米高考斩获30/100，主流fork是SukiSU-Ultra，有更多功能和diy主题
...
我第一次也是刷入boot.img结果就是没有用，这算是一个小坑。
...
刷入Zygisk基本有三个选择
1. Zygisk next 主流的选择，不过可惜的是next已经停止开源。看了下贡献者三个贡献者里有大名鼎鼎的[5ec1cff](https://github.com/5ec1cff)就释怀了， 这位千早爱音大佬的项目好多都闭源了，这项目据说是三贡献者讨厌有人把自己开源的软件魔改闭源卖钱干脆自己闭源了，不过我没有找到可靠的来源。老实这三贡献者人品都很好，不过不是我洁癖，把Zygisk这么重要的位置给闭源软件........**我不推荐任何人刷入**，亿万人得使用开源替代。
...
博主小白时期也曾有一次请别人的经历，不过我是患了一个巨蠢的错误——看错版本号了，结果就是病急乱投医，刷入了错误的完整OTA,结果很灾难，fastboot可以进的情况下，我看了一眼[lineageos](https://wiki.lineageos.org/devices/#nothing) 不支持加上自己吵架干啥心情巨糟糕感觉自己啥都能搞砸，就差跳了，就放弃了，现在想想还肉疼，[nothingTG社区](https://t.me/NothingPhone3aUpdates) 一堆Unofficial系统，一刷就省100。绝对是我花的最冤枉的钱，现在回忆起来还是后悔
...
pgntgz
26-3-9～3-11编辑完成
这是这个博客第一篇文章，有很多不足，我水平也就那样，但我真的受够了中文内容的圈子化。明明很多事情不需要那么麻烦，明明我们不需要llm做中间商，我不想要流量焦虑，bolg挺好，流量数据是抽象的不用焦虑，网站属于自己，，也有创作自由。我就要在一个可以被Google索引的地方留下一点东西。下一篇打算继续聊root。
