...
description: 从ss开始吵出来的我们的时代的基石，构筑我们的理所当然的代理项目的来源和经历
category: 技术
tags:
  - 长篇
  - 代理协议
...
虽然我不看MYGO和邦的一堆企划，但这句话用在这里确实再合适不过了。SS后的岁月大概就是我最熟悉的“理所当然”的时间，这段时间和理所当然的记忆也定会写入我们这代人的DNA之中。同样离开了远古时期，这个时期的资料好找的程度直线上升，这一篇的写作比写上一篇简单太多了。
...
### 争议
简单概括下SS逐渐被GFW识别，是开发者breakwa11主张通过复杂的“混淆（OBFS）”来对抗 GFW，clowwindy不同意坚持SS要轻量。结果就是breakwa11 fork了ShadowsocksR。

fork是开源常事，本来没啥，不过幽默的是breakwa11直接无视了Shadowsocks是GPLv3授权的，SSR用了SS就必须也用GPLv3公开源代码，早期breakwa11只发布SSR的二进制。到后面被指责是偷窃代码才开源。

SSR的技术上一样争议不断——SSR 引入了混淆功能，试图将流量伪装成普通网页访问被很多人认为是画蛇添足，反而更容易被GFW通过机器学习识别。反倒是大量被用于欺骗运营商免流量这种不道德的用途。

2015年8月22日SS作者clowwindy喝茶后，SSR哪怕失去了对手依然日子不好过，因为project V和VLESS无缝衔接了，SSR还是没法占据市场。

结果到了2017年，breakwa11整了个大活——2017 年 7 月，breakwa11 发布了一个闭源的“SS 被动检测程序”，声称可以探测 SS 服务器，引发了大伙对于她投靠GFW投毒的猜忌和恐慌。结果求仁得仁，恶俗TV对breakwa11使用了盒打击。
...
对此RPRX则觉得“至少任何人都还是可以审计 XTLS 的代码，所以这里没有风险。”“下游的开源协议对上游的确没有约束能力”“主项目已经从MIT欢了更严格的BSD”甚至为气血上头直接说“**Debian 的人都这么流氓吗？** 不好意思，**我本来就更喜欢 Red Hat 系**”有旁人提醒说“作爲一個 Fedora/openSUSE 使用者，我認爲你的這則回覆是在給 RPM 系發行版抹黑”结果RPRX暴脾气上来直接引用回复“我认为你哪凉快待哪去。”

暴论一出，本来关于许可证的讨论引发了由此的一连串争论彻底上纲上线，最后在issue 9爆发了这场肥皂剧。

反对的维护者觉得RPRX这是意识形态幼稚病，因为V2ray是自由软件，你换许可证啥许可证上什么发行版都无所谓，但是是不允许修改它的源代码并二次分发这**一条款使得V2ray项目不是开源软件**了。现在已经导致了有相关规定的仓库无法合并后续版本，难受无辜一般使用者。后面

再说了改许可证不能达到你想要的效果，——开源协议是君子协定，只在法制下有强制力。没有道德到用你到软件恰烂钱的人还会在意你的许可证？

而且哪怕从功利主义上讲。V2ray已经失去了前任维护者被迫把仓库改叫V2Fly，而且可以合法的转生在于整个项目都是MIT协议授权的，**万一你没了那么甚至没有第三方能在合法的情况下接手V2ray的开发**、因为你写的协议禁止了修改和二次开发。
...
但是说到底**模糊不清的许可证问题对于V2ray的开发工作是颗大雷**，最终V2ray维护者们经过投票确认XTLS不符合V2ray承诺遵守的MIT协议，并在V2ray-core 4.33.0版本移除了XTLS。RPRX则带着XTLS自己建立了project X。

不过幽默的是RPRX后续在还是project X妥协了把许可证换成了符合OSI标准的MPL-2.0。大批GUI客户端这才开始放心的把内核换成更优秀的X-core，X-core逐渐取代V2ray成为主流。

不过这场肥皂剧的的确确导致了开源社群的无法弥合的撕裂，比如说至今Debian主仓库只有V2ray没有X-core——至今无人愿意担任X-core的debian维护者
...
<center>*clash*</center>
相比V2ray分裂Clash经历的删库时间更加著名。不过相对V2ray，Clash删库时间则更加简单，是一出**三人成虎的闹剧**

[^9]根据当时还是民小区的太监区的讨论，起因是2023 年 11 月 2 日Clash一个客户端Clash For Windows（以下简称CFW）的维护者因为自己个人信息保护意识（据说发车牌生活照甚至收款码）不足挨了铁拳。

本来其实伤害不是很大，毕竟Clash核心正常维护就好，CFW本来就是完成状态的，有人接手继续合并新特性就没事，而且就是没人接手CFW也就是少了改客户端。
...
不过后来大家还是冷静了下来，clash只是贡献者跑路，代码又不会跑，而且V2ray，Xray，sing-box都好好的。Clash.meta（现在叫Mihomo）迅速在Clash的尸体上重建


### sing-box
而另一位sing-box的作者nekohasekai曾做过大名鼎鼎的SagerNet可能是觉得做GUI救不了中国人，转头写了sing-box。sing-box普及是在Clash遭遇大洪水后的事情。
...
说回nekohasekai和sing-box，nekohasekai本人简直就是劳模,他的github绿墙简直是在cos地铁的马赛克墙。加上来自著名的艺术家アボガド6的头像其主页的感觉强烈的克制感。

sing-box因为采用了严格的GPLv3使用的客户端必须自己也开源，所以很少客户端用。nekohasekai的解决方法十分**简单粗暴**——**我全做了**

他一人维护了原生的Android，IOS，MAC，[^10]就在最近7月14号他还搞定了Windows客户端。而且nekohasekai的前端水平一样无可挑剔的完美。拿Android版本说sing-box-for-android不但是极其现代的MD3应用，还支持ROOT增强抗检测，还成功上架了有开源洁癖的f-droid，市面仅此一家属于是。

nekohasekai一样无法免俗的有争议——他对代码貌似有近乎偏执的执着，sing-box最受争议的就是sing-box一直在优化性能和追求新的功能但没有考虑用户体验。sing-box对配置文件的JOSN偏执的严格，并且语法规范变化极快，这大概也是sing-box客户端那么完美还是不流行的原因。

nekohasekai引发最大的吵架是[^11]Xray呼吁不要用sing-box，因为nekohasekai对V2ray Xray这群老东西很不屑。还嘲讽很多客户端接广告说[^12]“此类项目维护者的动机是获得更多用户，即使它们提供友好的商业 VPN 客户端功能， 但代码质量很差且包含广告。”不过结果是这篇AI写的大字报哪怕发在/Xray-core的讨论组还是146赞61倒赞。

说实话，这里的篇幅本来没这么多，结果一查资料人人有架吵，我已经尽量少写一点了......
...
机场鱼龙混杂，面板一般是开源的Xboard和SSPanel-UIM改的，一个服务商被认定为是机场的核心要素就是其售卖的是可拉取的配置文件
...
## 现在
2026年，这一切好像都变了，好像又1️没变
![万恶之源 w-30%](https://box.pgntgz.top/posts/gfw/gfwhr.avif)
关于这次打击的来龙去脉也差不多出来了，就是泄密事件导致GFW警惕。封禁主要针对国内VPS的中转机场。

现在3改月过去了，大伙基本上也的换了AnyTLS。
