...
## 爽了再说（先推荐点东西再bb）
首先最好刷个lsp建议这个版本的[构建版](https://github.com/JingMatrix/LSPosed/actions)
### Iconify
...
首先
#### keybox
**最难的一关是keybox** nothing的tee不会物理损坏，理论是有解的，难点是要keybox伪装,就看本事了，本人有幸在bilbil拣到过一个可以用的，导入Evolution X就过了，原厂系统要打tricky store+play integrity fix，keybox因为难取得且google一直在封，我个人觉得是最难的一环。tg貌似有不少公开的搜索#Keybox 开启，不过公开的后果

#### 剩下的
剩下就好办了，兵来将挡，水来土掩。Zygisk Assistant消除注入痕迹，ksu本身就有隐藏再来个应用列表隐藏，这就可以过google钱包了，其他检查看着办基本就没事了
...
后来的改善是刷了开源安卓Evolution X，自己也摸清楚一点点门道了，用了Evolution X带的欺骗（可过依赖play完整性的第三方GPT这种，但骗不了google钱包就是了）是没有做多少隐藏的，为此我特意下了个腾讯的三角洲测试，能玩，但毕竟不真玩，所以究竟怎么样，我也不知道。

直到走狗屎运拿到keybox，达成了🟢🟢🔴算是我的最终版本了，钱包能过了，目前博主的环境是三项错误是ca证书错误（AdAway） rom版本不对劲（开源rom） play隐藏问题，不过基本上是没问题，为此我特意装了个据说很严的三角洲，能玩。不过友友说藤是人工审核为主我就不知道了
